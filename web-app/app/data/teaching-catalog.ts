    ...
    subjects: [
      {
        ...
        topics: [
          ...
          },
          {
            id: "basic-force",
            title: "基础受力分析",
            summary: "用测力计拖动木块，把静摩擦、滑动摩擦与受力平衡过程拆开看懂。",
            stageId: "junior",
            subjectId: "physics",
            mode: "2D",
            status: "优先开发",
            tags: ["力学", "摩擦", "实验"],
            highlights: ["支持分阶段实验播放", "联动拉力与摩擦变化", "自动记录测量结果"],
          },
          {
            id: "circuit-observer",
            title: "串并联电路观察",
            summary: "用可切换的电路图与通断状态，直观看懂串联、并联和用电器变化。",
            stageId: "junior",
            subjectId: "physics",
            mode: "2D",
            status: "后续扩展",
            tags: ["电学", "回路", "通断"],
            highlights: ["支持串联并联对照", "高亮电流路径与灯泡状态", "适合课堂实验讲解"],
          },
        ],
      },
      {
