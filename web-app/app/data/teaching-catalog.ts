    ...
    subjects: [
      {
        ...
        topics: [
          ...
          },
          {
            ...
            status: "优先开发",
            tags: ["力学", "浮力", "排液"],
            highlights: ["支持浸入与浸没对照", "同步测力计与排液验证", "可直接讲解阿基米德原理"],
          },
          {
            id: "circuit-observer",
            title: "串并联电路观察",
          ...
          },
          {
            ...
            status: "优先开发",
            tags: ["光学", "小孔成像", "直线传播"],
            highlights: ["验证倒立实像", "对照物距与像距变化", "观察清晰度与亮度取舍"],
          },
          {
            id: "eclipse-scattering-lab",
            title: "日食月食与光路可见性",
            summary: "把天文遮挡关系与烟雾散射导致的光路可见性放到同一页，帮助理解光的直线传播。",
            stageId: "junior",
            subjectId: "physics",
            mode: "2D",
            deliveryState: "implemented",
            status: "可开始",
            tags: ["光学", "日食月食", "散射"],
            highlights: ["支持日食月食切换", "可观察本影与半影", "可对照烟雾散射显光路"],
          },
          {
            id: "lens-imaging-lab",
            title: "凸透镜成像规律",
            ...
            status: "优先开发",
            tags: ["光学", "凸透镜", "成像"],
            highlights: ["覆盖 2f、f 等典型区间", "区分实像与虚像", "同步展示主光线与成像位置"],
          },
          {
            ...
            status: "优先开发",
            tags: ["光学", "折射", "介质"],
            highlights: ["支持空气水玻璃典型场景", "可观察全反射与视深变化", "突出法线与偏折方向"],
          },
          {
          ...
          },
          {
            ...
            status: "可开始",
            tags: ["热学", "熔化凝固", "图表"],
            highlights: ["同步显示状态与温度曲线", "直观看平台段差异", "适合课堂讲解熔点与凝固点"],
          },
          {
            id: "ohms-law-lab",
            title: "欧姆定律探究实验",
          ...
          },
          {
            ...
            status: "可开始",
            tags: ["电学", "滑动变阻器", "调压"],
            highlights: ["支持四种典型接线对照", "同步电流电压与亮度变化", "突出保护电路的起始操作"],
          },
        ],
      },
      {
