...
const EXACT_TRANSLATIONS: Record<string, string> = {
  ...
  "滑动摩擦力影响因素实验": "Sliding Friction Factors Lab",
  "通过匀速拉动对照压力、材质和接触面积，直观看懂滑动摩擦力大小规律。": "Compare normal force, surface material, and contact area with uniform pulling to understand the rules of sliding friction.",
  "摩擦力": "Friction Force",
  "压力": "Normal Force",
  "控制变量": "Control Variables",
  "支持多组对照记录": "Supports multi-run comparison records",
  "验证接触面积无关": "Verifies contact-area independence",
  ...
  "导通": "Conducting",
  "未通电": "Not Energized",
  "点击断开主开关": "Click to open the main switch",
  "点击闭合主开关": "Click to close the main switch",
  "点击断开 L1": "Click to open L1",
  "点击恢复 L1": "Click to restore L1",
  "点击断开 L2": "Click to open L2",
  "点击恢复 L2": "Click to restore L2",
  "串联结构": "Series Layout",
